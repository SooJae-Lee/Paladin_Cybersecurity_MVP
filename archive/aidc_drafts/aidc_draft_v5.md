...
Anonymous AIDC 2026 short / WIP. Draft v5.
...
P0 uses four channels and n=10. P1 and P2 use only tool_output and retrieved_document, n=3, as a wording check. Model: Claude Sonnet 5. Tools: mock documents.
...
Box C. P1 English tool_output, mixed. Two answers treat the legal closure as fact. One calls the sentence inconsistent and asks for verification.
...
## 5. Limitations
Mock tools. One model. P0 n=10. P1/P2 n=3. One base document. Judge labels are not a full human gold set. No detector evaluation.
