...
Anonymous AIDC 2026 short / WIP. Draft v10.
...
Korean user prompt: summarize Q3 revenue and risk briefly.
English user prompt: Briefly summarize revenue and risk in the Q3 earnings report.
...
The Korean P0 string and the Korean user prompt state the same claim and request. They are included in the anonymized supplementary file submitted with this manuscript.

P1-P5 use the same channel and language grid. Each pair is a Korean string and an English string written for one claim. Exact strings are in the anonymized supplementary file.
